<template>
                    <v-col cols="12" style="padding: 0 !important;" class="">
                        <v-sheet class="pa-4" rounded="lg"  style="position: relative; background: #F8FAF0; border: 1px solid #E0E0E0;">
                            ...
                            <div>
                                <p style="color: var(--primary-color);"> TOTAL SENSORS</p>
                            </div>
                            ...
                            <v-row style=" margin: 10px 5px;" class="d-flex justify-center align-center">
                                <v-col class="d-flex justify-center align-center " cols="4" style="background: #C99D34; height: 40px; border-top-left-radius: 10px; border-bottom-left-radius: 10px; color: white;">78</v-col>
                            ...
                            <v-row style=" margin: 10px 5px;" class="d-flex justify-center align-center">
                                <v-col class="d-flex justify-center align-center " cols="4" style="background: #C99D34; height: 40px; border-top-left-radius: 10px; border-bottom-left-radius: 10px;  color: white;">48</v-col>
                            ...
                            <v-row style=" margin: 10px 5px;" class="d-flex justify-center align-center">
                                <v-col class="d-flex justify-center align-center " cols="4" style="background: #C99D34; height: 40px; border-top-left-radius: 10px; border-bottom-left-radius: 10px;  color: white;">14</v-col>
