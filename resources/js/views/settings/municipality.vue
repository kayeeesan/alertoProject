...
import MunicipalityForm from "../../components/settings/municipality/form.vue";

const { municipalities, pagination, query, is_loading, getMunicipalities, destroyMunicipality } =
    useMunicipalities();
...
const showMunicipalityForm = async (is_show) => {
    municipality.value = {};
...
<template>
    <div style="text-align: end">
        <v-btn class="ma-2" color="blue-darken-1" @click="showMunicipalityForm(true)">
    ...
    <v-card>
        ...
        >
            <v-card-title>List of Municipalities </v-card-title>
